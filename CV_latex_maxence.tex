...
% ----------------------------
\AtBeginDocument{\setlength{\maketitlewidth}{\textwidth}}
...
\cventry%
  ...
  {%
    ...
    \begin{itemize}
        ...
        Conception et développement d’une application de \textbf{CMDB}, Réalisation de la modélisation des données, de la conception de l’API REST ainsi que de l’interface utilisateur. Développement des principales fonctionnalités métier permettant la gestion de l’inventaire complet (serveurs, équipements réseau, VLANs, adresses IP).
    ...
    notamment la transmission des identifiants utilisateurs vers l’Active Directory.
      ...
      \item \textbf{DevOps \& Déploiement automatisé~:}
            ...
            build automatique, registre d'images,
            déploiement en production déclenché à chaque \textit{push} sur la branche principale.
